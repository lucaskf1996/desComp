...
-- *****************************************************************************
-- Generated on "08/18/2021 11:08:25"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          memoriaNome
-- 
...
ENTITY memoriaNome_vhd_vec_tst IS
END memoriaNome_vhd_vec_tst;
ARCHITECTURE memoriaNome_arch OF memoriaNome_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
SIGNAL Dado : STD_LOGIC_VECTOR(7 DOWNTO 0);
SIGNAL Endereco : STD_LOGIC_VECTOR(9 DOWNTO 0);
COMPONENT memoriaNome
	PORT (
