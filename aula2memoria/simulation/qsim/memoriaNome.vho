...
-- Dado[0]	=>  Location: PIN_L19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[1]	=>  Location: PIN_P18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[2]	=>  Location: PIN_K21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[3]	=>  Location: PIN_N21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[4]	=>  Location: PIN_P19,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[5]	=>  Location: PIN_AA12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[6]	=>  Location: PIN_L18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[7]	=>  Location: PIN_R14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[0]	=>  Location: PIN_L17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[1]	=>  Location: PIN_M22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[2]	=>  Location: PIN_M20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[3]	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[4]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[5]	=>  Location: PIN_M18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[6]	=>  Location: PIN_P17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[7]	=>  Location: PIN_K22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[8]	=>  Location: PIN_M21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[9]	=>  Location: PIN_N19,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF memoriaNome IS
...
-- Equation(s):
-- \memROM~0_combout\ = ( !\Endereco[8]~input_o\ & ( !\Endereco[5]~input_o\ & ( (!\Endereco[7]~input_o\ & (!\Endereco[4]~input_o\ & (!\Endereco[6]~input_o\ & !\Endereco[9]~input_o\))) ) ) )
...
-- Equation(s):
-- \memROM~6_combout\ = ( !\Endereco[1]~input_o\ & ( \Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & (!\Endereco[0]~input_o\ & \memROM~0_combout\)) ) ) ) # ( \Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & 
-- \memROM~0_combout\) ) ) ) # ( !\Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & (\Endereco[0]~input_o\ & \memROM~0_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000100010000000001010101000000000100010000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~5_combout\ = ( !\Endereco[1]~input_o\ & ( \Endereco[2]~input_o\ & ( (\memROM~0_combout\ & (!\Endereco[3]~input_o\ & !\Endereco[0]~input_o\)) ) ) ) # ( \Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & 
-- (!\Endereco[3]~input_o\ & !\Endereco[0]~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000010100000000000001010000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~1_combout\ = ( !\Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & !\Endereco[3]~input_o\) ) ) )
...
-- Equation(s):
-- \memROM~2_combout\ = ( !\Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & (!\Endereco[0]~input_o\ & \memROM~0_combout\)) ) ) )
...
-- Equation(s):
-- \memROM~4_combout\ = ( !\Endereco[1]~input_o\ & ( \Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & (!\Endereco[0]~input_o\ & \memROM~0_combout\)) ) ) ) # ( !\Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (!\Endereco[3]~input_o\ & 
-- (\Endereco[0]~input_o\ & \memROM~0_combout\)) ) ) )
...
-- Equation(s):
-- \memROM~3_combout\ = ( !\Endereco[1]~input_o\ & ( \Endereco[2]~input_o\ & ( (\memROM~0_combout\ & (!\Endereco[3]~input_o\ & !\Endereco[0]~input_o\)) ) ) ) # ( \Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & 
-- !\Endereco[3]~input_o\) ) ) ) # ( !\Endereco[1]~input_o\ & ( !\Endereco[2]~input_o\ & ( (\memROM~0_combout\ & !\Endereco[3]~input_o\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0101000001010000010100000101000001010000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_memROM~0_combout\,
